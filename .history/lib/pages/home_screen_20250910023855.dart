...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    //Riverpod StreamProvider that listens to Firestore’s items collection.
    //itemsCollectionProvider returns a stream of all documents (QueryDocumentSnapshots).
    final itemsAsync = ref.watch(itemsCollectionProvider); 

    //simple Riverpod StateProvider that holds which item the user has currently selected
