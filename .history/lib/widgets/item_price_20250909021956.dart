...
import '../riverpod.dart'; // your Riverpod file
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return selectedItemAsync.when(
      data: (selectedSnapshot) {
        ...
        final price = selectedData['price']?.toString() ?? '0';
        final endTimestamp = selectedData['endTime'];
        final bidderCount = selectedData['bidderCount']?.toString() ?? '0';
        final favoriteCount = selectedData['favoriteCount'] ?? 0;
