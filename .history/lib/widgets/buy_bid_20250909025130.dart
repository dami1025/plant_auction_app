    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: Text(
          ...
          style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: kBackgroundColor),
        ),
            ),
      ));
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("Bid placed successfully!"), backgroundColor: kPrimaryColor),
                  );
                } catch (e) {
